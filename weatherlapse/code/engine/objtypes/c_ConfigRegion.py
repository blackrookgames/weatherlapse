...
class ConfigRegion(_xml2.XmlLoadable, _xml2.XmlSavable):
    ...
    MAXCOORD = _col.ROList[int]([ 2 ** _i for _i in range(MAXZOOM + 1) ])
    ...
    def normalize(self):
        """
        Computes the normalized coordinates

        :return: Normalized zoom, min_x, min_y, max_x, and max_y
        """
        zoom = self.__zoom
        min_x = self.__min_x
        min_y = self.__min_y
