...
class SubJob(_tk.Toplevel):
    ...
    def __update(self):
        ...
        if self.__started:
            ...
            while not self.__oqueue.empty():
                ...
                self.__state = _SubJobState(int(_argv[0]))
                match self.__state:
        ...
        # No! Start it.
            ...
            self.__started = True
            p = self._create_job(self.__iqueue, self.__oqueue)
            p.start()
        # Redraw
        self.__redraw()
        # Next
    ...
    def _create_job(self, iqueue:_mp.Queue, oqueue:_mp.Queue) -> _mp.Process:
        """
        ...
        """
        raise NotImplementedError("_create_job has not been implemented")
